...
urlpatterns = [
    ...
    path("periods/", ClassroomPeriodListView.as_view(), name="classroomPeriod_list_view"),
    ...
    path("classroom_period/<int:id>/", ClassroomPeriodDetailView.as_view(), name="classroom_periods_detail_view"),
    path("courses/<int:id>/", CoursesDetailView.as_view(), name="courses_detail_view"), 
    path("teachers/<int:id>/", TeacherDetailView.as_view(), name="teachers_detail_view")
]
